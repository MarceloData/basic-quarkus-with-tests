...
// /**
// * Allows the default config profile to be overridden. This basically just
// sets
...
// /**
// * Additional {@link QuarkusTestResourceLifecycleManager} classes (along with
// * their init params) to be used from this
// * specific test profile.
// *
// * If this method is not overridden, then only the
// * {@link QuarkusTestResourceLifecycleManager} classes enabled via the
// * {@link io.quarkus.test.common.QuarkusTestResource} class
// * annotation will be used for the tests using this profile (which is the same
// * behavior as tests that don't use a profile at all).
// */
// @Override
// public List<TestResourceEntry> testResources() {
// return Collections.singletonList(new
// TestResourceEntry(CustomWireMockServerManager.class));
// }

// /**
// * If this returns true then only the test resources returned from
// * {@link #testResources()} will be started,
...
// * When the {@code quarkus.test.profile.tags} System property is set (its
// value
// * is a comma separated list of strings)
// * then Quarkus will only execute tests that are annotated with a
// * {@code @TestProfile} that has at least one of the
...
// /**
// * If this method returns true then all {@code StartupEvent} and
// * {@code ShutdownEvent} observers declared on application
